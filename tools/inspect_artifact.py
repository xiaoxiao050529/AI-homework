...
Examples:
    python3 tools/inspect_artifact.py docs/实验二说明文档.docx --output docs/实验二说明文档.txt
    python3 tools/inspect_artifact.py outputs/mlp_best.pt --output outputs/mlp_best_summary.json
"""
